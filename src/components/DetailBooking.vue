        ...
        <div class="row" >
          <!-- <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
            ...
            <div>
                ...
                <router-link class="buttonOrder" :to="{name:'booking',params:{id:films.id}}"><i style="color:white" class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;Order Tiket</router-link>
            </div> -->
        </div>
</template>
